...
; Generated by Claude Jaspart on 29/06/2022 (UTC)
;
[Setup]
AppID={{77d3ed0e-8896-4bb5-9e8f-1d5089c84ef3}
AppName=ASCOM GuideScopeFocuser Focuser Driver
AppVerName=ASCOM GuideScopeFocuser Focuser Driver 1.0.0
AppVersion=1.0.0
AppPublisher=Claude Jaspart <test>
AppPublisherURL=mailto:test
...
OutputDir="."
OutputBaseFilename="GuideScopeFocuser Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\GuideScopeFocuser"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\GuideScopeFocuser"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\Claude\OneDrive\Documents\ASCOM DEV\GuideScopeFocuserDriver\bin\Release\ASCOM.GSCFOC.Focuser.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\Claude\OneDrive\Documents\ASCOM DEV\GuideScopeFocuserDriver\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.GSCFOC.Focuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.GSCFOC.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.GSCFOC.Focuser.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.GSCFOC.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.GSCFOC.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
