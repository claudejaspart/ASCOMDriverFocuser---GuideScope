...
//
// ASCOM Focuser driver for GSCFOC
//
...
namespace ASCOM.GSCFOC
{
    //
    // Your driver's DeviceID is ASCOM.GSCFOC.Focuser
    //
    // The Guid attribute sets the CLSID for ASCOM.GSCFOC.Focuser
    // The ClassInterface/None attribute prevents an empty interface called
    // _GSCFOC from being created and used as the [default] interface
    //
    ...
    /// ASCOM Focuser Driver for GSCFOC.
    /// </summary>
    [Guid("fdc2a749-0739-4daa-8768-ac2fe65a67e1")]
    ...
    public class Focuser : IFocuserV3
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.GSCFOC.Focuser";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Focuser Driver for GSCFOC.";
        ...
        internal static int speed = 2; //ms
        internal static int numberTurns = 4;
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GSCFOC"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public Focuser()
        {
            tl = new TraceLogger("", "GSCFOC");
